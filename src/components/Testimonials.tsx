    ...
    <section className="bg-tan py-20">
      <Container>
        <SectionHeading
          ...
          description="A few of the small and medium businesses we've helped grow roots — and grow large. (Placeholder testimonials shown — swap in your own client quotes anytime.)"
        />
